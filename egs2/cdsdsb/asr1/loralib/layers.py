...
class DEELoRALinear(nn.Linear, LoRALayer):
    def __init__(
        ...
        **kwargs
        ...
        # ====================== 新增：读取预分配秩文件 ======================
        rank_file_path = "/home/q/espnet/egs2/cdsdsb/asr1/exp/asr_train_asr_whisper_small_gora_raw_zh_whisper_multilingual48rank/gora_rank_allocation.json"  #32rank分秩
...
class DEEGoRALinear(nn.Linear, LoRALayer):
    def __init__(
        ...
        **kwargs
        ...
        # ====================== 新增：读取预分配秩文件 ======================
        rank_file_path1 = "/home/q/espnet/egs2/cdsdsb/asr1/exp/asr_train_asr_whisper_small_gora_raw_zh_whisper_multilingual30rank/gora_rank_allocation.json"  #32rank分秩
